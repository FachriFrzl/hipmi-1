    ...
    <div class="container mx-auto px-6 py-8">
        <div class="flex items-center">
            <button class="text-white focus:outline-none bg-gray-900 px-4 py-2 shadow-sm rounded-md">
                <a href="{{ route('admin.story.create') }}" class="text-white flex"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                    ...
                    <thead class="justify-between">
                        <tr class="bg-gray-900 w-full">
                            ...
                            <th class="px-16 py-2" style="width: 60%">
                                <span class="text-white">Nama dan deskripsi</span>
                            </th>
                            <th class="px-16 py-2" style="width: 60%">
                                <span class="text-white">Judul</span>
                            </th>
                            <th class="px-16 py-2" style="width: 60%">
                                <span class="text-white">Negara</span>
                            </th>
                            <th class="px-16 py-2">
                        ...
                        @forelse($story as $item)
                            <tr class="border bg-white">
                                <td class="px-10 py-2 flex justify-center">
                                    <img src="{{asset('storage/story/'.$item->image)}}" class="admin-index-image">
                                </td>
                                ...
                                <td class="px-5 py-2">{{$item -> judul}}
                                </td>
                                <td class="px-5 py-2">{{$item -> negara}}
                                </td>
