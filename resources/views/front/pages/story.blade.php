      ...
      <section id="about" class="about">
        <div class="container" data-aos="fade-up">
          ...
          <div class="row gy-4" style=" margin-left: 7rem; margin-right: 7rem;">
            <div class="col-lg-7 position-relative about-img aos-init aos-animate" style="background-image: url(assets/img/1.jpg)" data-aos="fade-up" data-aos-delay="150"></div>
