    ...
    <div class="container mx-auto px-6 py-8">
        <div class="flex items-center">
            <button class="text-white focus:outline-none bg-gray-900 px-4 py-2 shadow-sm rounded-md">
                <a href="{{ route('admin.daftarform.create') }}" class="text-white flex">
            ...
            <div class="relative mx-4">
                ...
                <form action="{{ route('admin.daftarform.index') }}" method="GET">
                ...
                <table class="min-w-full table-auto">
                    <thead class="justify-between">
                        <tr class="bg-gray-900 w-full">
                            ...
                            <th class="px-16 py-2">
                                <span class="text-white">Nama Perusahaan</span>
                            </th>
                            <th class="px-16 py-2" style="width: 60%">
                                <span class="text-white">Jenis Usaha</span>
                            </th>
                            <th class="px-16 py-2" style="width: 60%">
                                <span class="text-white">Alamat Perusahaan</span>
                            </th>
                            <th class="px-16 py-2" style="width: 60%">
                            ...
                            <th class="px-16 py-2" style="width: 60%">
                                <span class="text-white">No Telepon</span>
                            </th>
                            <th class="px-16 py-2" style="width: 60%">
                                <span class="text-white">Deskripsi Perusahaan</span>
                            </th>
                            <th class="px-16 py-2" style="width: 60%">
                                <span class="text-white">Email Perusahaan</span>
                            </th>
                            <th class="px-16 py-2">
