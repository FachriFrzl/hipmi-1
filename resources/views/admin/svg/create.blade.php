@extends('layouts.app', ['title' => 'Tambah svg - Admin'])
...
<main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-300">
    <div class="container mx-auto px-6 py-8">
        ...
        <div class="p-6 bg-white rounded-md shadow-md">
            ...
            <hr class="mt-4">
            <form action="{{ route('admin.svg.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="grid grid-cols-1 gap-6 mt-4">
                    ...
                    <div>
                        ...
                        <input class="form-input w-full mt-2 rounded-md bg-gray-200 focus:bg-white" type="text" name="nama" value="{{ old('nama') }}" placeholder="Di isi dengan angka">
                        @error('nama')
                            <div class="w-full bg-red-200 shadow-sm rounded-md overflow-hidden mt-2">
                                <div class="px-4 py-2">
                                    <p class="text-gray-600 text-sm">{{ $message }}</p>
